...
chanceCards[10] = new Card("ADVANCE to " + square[39].name + ".", function() { advance(39);});
chanceCards[11] = new Card("ADVANCE to " + square[24].name + ". If you pass \"GO\" collect £200.", function() { advance(24);});
...
chanceCards[14] = new Card("ADVANCE to " + square[11].name + " If you pass \"GO\" collect £200.", function() { advance(11);});
